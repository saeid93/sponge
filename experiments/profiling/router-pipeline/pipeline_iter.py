...
def save_report(
    ...
    save_path = os.path.join(
        PIPELINE_PROFILING_RESULTS_PATH, "series", str(series), f"{experiment_id}.json"
    )
...
def backup(series):
    data_path = os.path.join(PIPELINE_PROFILING_RESULTS_PATH, "series", str(series))
    backup_path = os.path.join(
        OBJ_PIPELINE_PROFILING_RESULTS_PATH, "series", str(series)
    )
