...
# sleep 90
# python runner_script.py --config-name video-21
# sleep 90
# python runner_script.py --config-name video-22
# sleep 90
# python runner_script.py --config-name video-23
# sleep 90
# python runner_script.py --config-name video-24
# sleep 90
# python runner_script.py --config-name video-25
# sleep 90
# python runner_script.py --config-name video-26
# sleep 90
# python runner_script.py --config-name video-27
# sleep 90
# python runner_script.py --config-name video-28
# sleep 90
# python runner_script.py --config-name video-29
# sleep 90
# python runner_script.py --config-name video-30
# sleep 90
python runner_script.py --config-name video-32