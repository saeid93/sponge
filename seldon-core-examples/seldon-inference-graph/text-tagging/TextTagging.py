...
class TextTagging(object):
    ...
    def predict(self, X, features_names, meta):
        if meta and 'tags' in meta and 'sentiment_analysis_passed' in meta['tags'] and meta['tags']['sentiment_analysis_passed']:
            ...
            # Uncommon words
            freq1 = pandas.Series(' '.join(corpus).split()).value_counts()[-20:]
