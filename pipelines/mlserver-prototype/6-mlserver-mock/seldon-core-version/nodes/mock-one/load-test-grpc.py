...
# ax.grid()
# fig.savefig(f"grpc-{platform}_variant_{variant}-roundtrip_lat-load-{load}-test_duration-{test_duration}.png")
# plt.show()
...
# ax.grid()
# fig.savefig(f"grpc-{platform}_variant_{variant}-sending_time-load-{load}-test_duration-{test_duration}.png")
# plt.show()
...
# ax.grid()
# fig.savefig(f"grpc-{platform}_variant_{variant}-server_arrival_time_from_start-load-{load}-test_duration-{test_duration}.png")
# plt.show()
...
ax.grid()
fig.savefig(f"grpc-{platform}_variant_{variant}-server_recieving_latency-load-{load}-test_duration-{test_duration}.png")
plt.show()