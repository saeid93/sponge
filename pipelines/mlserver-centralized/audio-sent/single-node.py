...
PATH = "/home/cc/malleable-scaler/pipelines/seldon-prototype/paper-audio-sent/seldon-core-version"
PIPELINES_MODELS_PATH = (
    "/home/cc/malleable-scaler/data/pipeline-test-meta"  # TODO fix be moved to utilspr
)
DATABASE = "/home/cc/malleable-scaler/data/pipeline"
CHECK_TIMEOUT = 60
RETRY_TIMEOUT = 90
DELETE_WAIT = 45
LOAD_TEST_WAIT = 60
