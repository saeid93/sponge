...
def config_builder(
  name: str, platform: str, source: str, max_batch_size: int = None):
...
def model_generator(
    ...
    for source, model_name, version, subfolder in zip(
        source, model_names, versions, subfolders):
...
# remove junks
os.system(f"rm {PATH}/triton-inferline/yolo*")
