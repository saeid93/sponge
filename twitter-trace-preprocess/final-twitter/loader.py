...
path = "/home/cc/infernece-pipeline-joint-optimization/twitter-trace-preprocess/final-twitter/workload.txt"
def get_workload():
    f = open(path, "r")
    data = f.read()
    workload =  data.split(" ")
...
workload = workload_generator("3-5")
print(len(workload))